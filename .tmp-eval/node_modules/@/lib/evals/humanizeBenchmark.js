...
exports.HUMANIZE_BENCHMARK = exports.HUMANIZE_BENCHMARK_VERSION = void 0;
exports.HUMANIZE_BENCHMARK_VERSION = "beta-2026-04-08";
exports.HUMANIZE_BENCHMARK = [
    {
        ...
        tone: "natural",
        mode: "school",
        inputText: "I learned a lot from this group project because it showed me that communication is very important when different people are trying to finish the same task. At first, the process felt disorganized and a little stressful, but by the end we were able to divide the work more clearly and finish on time.",
    },
    {
    ...
    },
    {
        ...
        tone: "natural",
        mode: "standard",
        inputText: "The cafe was nice and the service was fast, but the music was too loud which made it hard to talk normally. Because of this, the overall experience was good in some ways but not fully relaxing.",
    },
    {
